...
//    更新歌曲URL
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations("file:/IntelljIDEAProjects/music-server/img/songPic/");
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations("file:/IntelljIDEAProjects/music-server/img/singerPic/");
            registry.addResourceHandler("/img/songListPic/**").addResourceLocations("file:/IntelljIDEAProjects/music-server/img/songListPic/");
            registry.addResourceHandler("/song/**").addResourceLocations("file:/IntelljIDEAProjects/music-server/song/");
            registry.addResourceHandler("/avatorImages/**").addResourceLocations("file:/IntelljIDEAProjects/music-server/avatorImages/");
...
//        boolean o = false;
//        o = listSongService.deleteListSong(Integer.parseInt(id));
//        if(o) System.out.println(id);
